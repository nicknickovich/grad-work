...
def test_api_add_new_employee(test_client, init_database):
    ...
    test_client.post("/api_v2/employee", json=new_employee)
    response = test_client.get("api_v2/employee/3")
...
def test_api_update_employee(test_client, init_database):
    ...
    test_client.put("/api_v2/employee/2", json=updated_employee)
    response = test_client.get("api_v2/employee/2")
